...
```   
For more information You can visit [Javadoc SDK Documentation](http://eddyplugins.com/docs/HDE_JAVA_SDK/index.html) and official [HelpDeskEddy API Documentation](https://helpdeskeddy.ru/api.html)
